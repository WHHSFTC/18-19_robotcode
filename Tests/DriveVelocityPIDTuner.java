 ...
 * WiFi network and navigate to 192.168.49.1:8080/dash in your browser. Once you've
 ...
 */
@Config
@Autonomous( name = "DriveVelPIDTune", group = "Test")
public class DriveVelocityPIDTuner extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        PIDCoefficients currentCoeffs = ((SampleMecanumDriveREV) drive).getPIDCoefficients(DcMotor.RunMode.RUN_USING_ENCODER);
        ...
        while (!isStopRequested()) {
            ...
            if (!pidEquals(currentCoeffs, MOTOR_PID)) {
                ...
                ((SampleMecanumDriveREV) drive).getPIDCoefficients(DcMotor.RunMode.RUN_USING_ENCODER);
            }
